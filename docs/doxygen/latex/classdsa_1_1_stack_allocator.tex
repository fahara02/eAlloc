...
void \mbox{\hyperlink{classdsa_1_1_stack_allocator_abf5b9cd9ea637250a038a89acda63579}{set\+Lock}} (\mbox{\hyperlink{classglock_1_1_i_lockable}{glock\+::\+ILockable}} \texorpdfstring{$\ast$}{*}lock)
...
\item To enable, call \doxylink{classdsa_1_1_stack_allocator_abf5b9cd9ea637250a038a89acda63579}{set\+Lock()} with a \doxylink{classglock_1_1_i_lockable}{glock\+::\+ILockable}\texorpdfstring{$\ast$}{*} mutex adapter.
...
\end{DoxyCode}
\Hypertarget{classdsa_1_1_stack_allocator_abf5b9cd9ea637250a038a89acda63579}\index{dsa::StackAllocator$<$ T, PoolSize $>$@{dsa::StackAllocator$<$ T, PoolSize $>$}!setLock@{setLock}}
...
{\footnotesize\ttfamily \label{classdsa_1_1_stack_allocator_abf5b9cd9ea637250a038a89acda63579} 
template$<$typename T, size\+\_\+t Pool\+Size$>$ \\
void \mbox{\hyperlink{classdsa_1_1_stack_allocator}{dsa\+::\+Stack\+Allocator}}$<$ T, Pool\+Size $>$\+::set\+Lock (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classglock_1_1_i_lockable}{glock\+::\+ILockable}} \texorpdfstring{$\ast$}{*}}]{lock}{}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}
...
\begin{DoxyParams}{Parameters}
{\em lock} & Pointer to a \doxylink{classglock_1_1_i_lockable}{glock\+::\+ILockable} mutex adapter.\\
\hline
\end{DoxyParams}
If not set, the allocator is not thread-\/safe. For host builds, use glock\+::\+Std\+Mutex. For embedded, use the appropriate platform adapter. Locking is delegated to \doxylink{classdsa_1_1e_alloc}{e\+Alloc}. 
